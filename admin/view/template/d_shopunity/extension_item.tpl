		...
		<div class="ibox">
			...
			<div class="ibox-content">
				...
				<?php if($extension['installable'] && !$extension['installed']){ ?>
	            	<a class="btn btn-info btn-block show-loading install-extension" data-href="<?php echo $extension['install']; ?>"  data-toggle="tooltip" data-original-title="Install"><span class="fa fa-plus"></span> Install</a>
	            <?php } ?>
