d_shopunity_widget = {
    ...
    loadExtension: function($extension_id){
        $( this.setting.class ).load( this.setting.http+"index.php?route=d_shopunity/extension/show_thumb&extension_id="+$extension_id+"&token="+this.setting.token + " .extension-show-thumb");
    },

    loadUpdate: function($extension_id){
        $( this.setting.class ).load( this.setting.http+"index.php?route=d_shopunity/extension/show_update&extension_id="+$extension_id+"&token="+this.setting.token + " .extension-show-thumb");
    },
